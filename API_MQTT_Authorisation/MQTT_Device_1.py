...
import time
import json
dev_device_id='LIGHT1'
dev_router_id='ABCD123'
dev_group_id='OFFICE'
dev_status='ON'
current_time=0
prev_time=0
...
dev_group_id=str(dev_group_id).upper()
broker_address="localhost"
device_publishing_url="smarthome/status"
device_subscribing_url="smarthome/command"
node_id=dev_router_id+dev_group_id+dev_device_id
...
def on_message(client,userdata,msg):
    ...
    #                 print("Different")
                    dev_status=status
                    client.publish(device_publishing_url,str(dev_router_id+"/"+dev_group_id+"/"+dev_device_id+"/"+dev_status))
